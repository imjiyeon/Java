...
/*
 * 1. 학번, 이름, 국어점수, 수학점수, 영어점수를 속성으로 갖는 학생(Student) 클래스를 만드세요.
 * 
 * 2. 학생을 저장하는 map 객체를 생성하세요.
 * 학번을 키로 사용하고, 학생정보를 값으로 사용합니다.
 * 
 * 3. 다음과 같이 맵에 학생 3명을 추가하세요.
 * (학번:1001, 이름:둘리, 국어점수:90, 수학점수:80, 영어점수:70)
 * (학번:1002, 이름:도우너, 국어점수:55, 수학점수:65, 영어점수:75)
 * (학번:1003, 이름:또치, 국어점수:80, 수학점수:50, 영어점수:50)
 * 
 * 4. 학생별 총점과 평균점수를 구하세요.
 * ex) 둘리학생의 총점: 240, 평균: 80.0
 * 
